...
func main() {
	...
	r.HandleFunc("/books/management", getBooksManagement).Methods("GET")
	r.HandleFunc("/books/search/{search}", getBooksSearch).Methods("GET")
	r.HandleFunc("/books/salesbygenre", getSalesByGenre).Methods("GET")
	r.HandleFunc("/books/salesbyauthor", getSalesByAuthor).Methods("GET")
	r.HandleFunc("/books/getpricevsexpenditure", getPriceVsExpenditure).Methods("GET")
	r.HandleFunc("/books/cart", getCartBooks).Methods("GET")
	r.HandleFunc("/books", createBook).Methods("POST")
	r.HandleFunc("/books/hide/{id}", hideBook).Methods("PUT")
